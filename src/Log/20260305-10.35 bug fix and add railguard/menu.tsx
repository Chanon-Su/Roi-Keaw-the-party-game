    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex-1 p-4">
                ...
                {/* [Claude] แสดงเฉพาะเมื่อถึง limit */}
                {playerCountHint && (
                ...
                {/* [Claude] เตือนใต้ปุ่ม Start เมื่อชื่อไม่ครบ */}
                {!allNamesFilled && (
                    <p className="start-hint">* กรุณากรอกชื่อผู้เล่นให้ครบทุกคนก่อนเริ่ม</p>
                )}
            </div>
