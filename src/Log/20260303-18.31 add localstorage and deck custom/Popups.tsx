            ...
            <div className="popup popup-howtoplay">
                ...
                {props.language === "th" ? (
                    <>
                        ...
                        <p style={{ color: "#aaa", fontSize: "14px", marginTop: "8px" }}>🚧 เนื้อหากำลังจะมา</p>
                    </>
                ) : (
                    <>
                                ...
                                >
                                    <div className="deck-card-info">
                                        ...
                                        <p className="deck-card-name">
                                            ...
                                            {/* [Claude] ใช้ deck.id เป็นชื่อ (ตรงกับชื่อไฟล์ JSON) */}
                                            {deck.id}
                                        </p>
    ...
    return (
        <div className="popup-backdrop">
            <div className="popup popup-fullscreen">
                ...
                {/* [Claude] ใช้ deck.id เป็นชื่อ (ตรงกับชื่อไฟล์ JSON) */}
                <h3 className="popup-title">🃏 {previewDeck?.id}</h3>
