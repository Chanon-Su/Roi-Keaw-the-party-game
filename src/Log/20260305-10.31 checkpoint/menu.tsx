...
export default function Menu(props: MenuProps) {
    ...
    // [Claude] ทุกครั้งที่ชื่อเปลี่ยน → บันทึกลง localStorage ทันที
    // ผู้ใช้รีเฟรชหน้า → ชื่อยังอยู่
    function updatePlayerName(indexToUpdate: number, newName: string) {
        ...
        savePlayers(updatedPlayers); // [Claude] save ทุกครั้งที่แก้ชื่อ
    }
    ...
    function addPlayer() {
        ...
        const updatedPlayers = [...props.players, ""];
        props.setPlayers(updatedPlayers);
        savePlayers(updatedPlayers); // [Claude] save หลัง add ด้วย
    }
    ...
    function removePlayer(indexToRemove: number) {
        ...
        props.setPlayers(updatedPlayers);
        savePlayers(updatedPlayers); // [Claude] save หลัง remove ด้วย
    }
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex-1 p-4">
                ...
                <button className="full_button" onClick={addPlayer}>+</button>

                <div className="flex gap-3">
                    <button className="half_button" onClick={props.onOpenHowToPlay}>📖 How to play</button>
                    <button className="half_button" onClick={props.onOpenDeck}>🃏 Deck</button>
                </div>
            ...
            <div className="p-4 text-center text-sm text-gray-400">
                <p>Terms of service · Privacy · Contact us</p>
            </div>
