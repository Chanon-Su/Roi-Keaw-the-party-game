...
import Menu, { loadPlayers, clearPlayers } from './components/menu.tsx';
import { SettingPopup, HowToPlayPopup, DeckPopup } from './components/Popups.tsx';
import deckOriginal from "./data/deck-original.json";
import type { Deck_type } from "./types/card.ts";
import { loadLanguage, saveLanguage, type Language } from "./i18n.ts";
